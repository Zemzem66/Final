...
public class NoteDTO {
     ...
     */
    public NoteDTO(Integer id, String note, String created, Integer document, Integer user) {
        this.id = id;
        this.note = note;
    ...
    public NoteDTO created(String created) {
        this.created = created;
        return this;
    }
    ...
    public NoteDTO document(Integer document) {
        this.document = document;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, noteDTO.id) &&
                Objects.equals(this.note, noteDTO.note) &&
                Objects.equals(this.created, noteDTO.created) &&
                Objects.equals(this.document, noteDTO.document) &&
