...
public class Savedview {
    ...
    private Set<Savedviewfilterrule> savedViewSavedviewfilterruleEntities;
    ...
    public Set<Savedviewfilterrule> getSavedViewDocumentsSavedviewfilterrules() {
        return savedViewSavedviewfilterruleEntities;
    }

    public void setSavedViewDocumentsSavedviewfilterrules(
            final Set<Savedviewfilterrule> savedViewSavedviewfilterruleEntities) {
        this.savedViewSavedviewfilterruleEntities = savedViewSavedviewfilterruleEntities;
    }
}
