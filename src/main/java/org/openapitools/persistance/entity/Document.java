...
public class Document {
    ...
    private Set<Note> documentNoteEntities;

    @OneToMany(mappedBy = "document")
    private Set<DocumentTag> documentTagsEntities;
    ...
    public void setDocumentNoteEntities(final Set<Note> documentNoteEntities) {
        this.documentNoteEntities = documentNoteEntities;
    }

    public void setDocumentTagsEntities(
            final Set<DocumentTag> documentDocumentTagsEntities) {
